...
bool set_sample_timer_1(double clock_frequency, uint8_t prescaller_value, bool active_noise_canceler);
bool set_sample_timer_2(double clock_frequency, uint8_t prescaller_value, bool active_noise_canceler);
