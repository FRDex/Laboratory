...
/*SETUP*/
static const uint16_t potenciometer_positive_90_degrees_value = 642;
static const uint16_t potenciometer_0_degrees_value = 523;
static const uint16_t potenciometer_negative_90_degrees_value = 406;
