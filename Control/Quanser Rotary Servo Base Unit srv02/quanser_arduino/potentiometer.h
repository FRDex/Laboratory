...
/*SETUP*/
static const uint16_t potenciometer_positive_90_degrees_value = 646; 
static const uint16_t potenciometer_0_degrees_value = 526; 
static const uint16_t potenciometer_negative_90_degrees_value = 410; 
